...
const Testimonial = (props) => {
    ...
    mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md'>
        ...
        <div>
            <div className='flex text-3xl mt-10 gap-3 text-violet-400 font-bold mx-auto px-12'>
                <button  className='cursor-pointer hover:text-violet-500 ' onClick={() => leftShiftHandler(index)}>
                    <FiChevronLeft/>
                </button>
                <button  className='cursor-pointer hover:text-violet-500 ' onClick={() => rightShiftHandler(index)}>
                    <FiChevronRight/>
                </button>
            </div>
            <div className="mt-6"> 
